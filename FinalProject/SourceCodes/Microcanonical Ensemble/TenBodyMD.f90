...
!
! Program Purpose:
!                  Solve 3D ten-bodies problem in molecule simulation. (Microcanonical Ensemble)
!  Version message:
...
real*8 potential_energy_total, kinetic_energy_total                                                                     ! system's total potnetial and kinetic energy                                                                                          ! damping coefficient
...
call compute_acceleration(x_current,u_current,acceleration,acceleration_int)                 ! Compute acceleration at first time step
...
call OutputParameters(x_current,u_current,kinetic_energy,potential_energy,kinetic_energy_total, potential_energy_total)
...
do t = 2,N_time
   ...
   ! Compute acceleration
     call compute_acceleration(x_current,u_current,acceleration,acceleration_int)
   ...
   ! Output    
       if(mod(t,Output_interval).EQ.0) then
          ...
          print 200, (t-1)
          print 201, kinetic_energy_total, potential_energy_total,  kinetic_energy_total+potential_energy_total
          print *,  ''     
          Write(10,100) (t-1)*delta_t,&
&         x_current(1,1), x_current(1,2), x_current(1,3), u_current(1,1), u_current(1,2), u_current(1,3),&
&           acceleration_int(1,1), acceleration_int(1,2), acceleration_int(1,3), kinetic_energy(1), potential_energy(1),& 
...
201 format(1x,'SystemKineticEnergy = ',ES15.5,', SystemPotentialEnergy=',ES15.5,', SystemMachanicalEnergy = 'ES15.5)

 close(10)

! Output computing log file
call logfile(t,x_current,u_current,kinetic_energy,potential_energy,potential_energy_total, kinetic_energy_total)
...
!------------------------------------------------------------------------------------------------
SUBROUTINE OutputParameters(x_current,u_current,kinetic_energy,potential_energy,kinetic_energy_total, potential_energy_total)
use ParametersBlock
implicit none
...
Write(*,113) potential_energy_total, kinetic_energy_total
113 format(1x,'SystemPotentialEnergy = ',ES15.5,', SystemKineticEnergy = ',ES15.5/)
...
Write(20,113) potential_energy_total, kinetic_energy_total
...
!------------------------------------------------------------------------------------------------
! Compute force
SUBROUTINE compute_acceleration(x_current,u_current,acceleration,acceleration_int)
use ParametersBlock
implicit none
...
!------------------------------------------------------------------------------------------------
SUBROUTINE logfile(t,x_current,u_current,kinetic_energy,potential_energy,potential_energy_total, kinetic_energy_total)
use ParametersBlock
implicit none
...
&            kinetic_energy(10), potential_energy(10)
Write(20,114) potential_energy_total, kinetic_energy_total
...
&          ', k10 = ',ES15.5,', p10 = ',ES15.5,/)
114 format(1x,'SystemPotentialEnergy = ',ES15.5,', SystemKineticEnergy = ',ES15.5/)
