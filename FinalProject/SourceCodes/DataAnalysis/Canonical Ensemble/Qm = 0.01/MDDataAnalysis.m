...
%         VX(equlibriumTimeStep:M,2),VY(equlibriumTimeStep:M,2),VZ(equlibriumTimeStep:M,2),...
%         VX(equlibriumTimeStep:M,3),VY(equlibriumTimeStep:M,3),VZ(equlibriumTimeStep:M,3),...
%         VX(equlibriumTimeStep:M,4),VY(equlibriumTimeStep:M,4),VZ(equlibriumTimeStep:M,4),...
%         VX(equlibriumTimeStep:M,5),VY(equlibriumTimeStep:M,5),VZ(equlibriumTimeStep:M,5),...
%         VX(equlibriumTimeStep:M,6),VY(equlibriumTimeStep:M,6),VZ(equlibriumTimeStep:M,6),...
%         VX(equlibriumTimeStep:M,7),VY(equlibriumTimeStep:M,7),VZ(equlibriumTimeStep:M,7),...
%         VX(equlibriumTimeStep:M,8),VY(equlibriumTimeStep:M,8),VZ(equlibriumTimeStep:M,8),...
%         VX(equlibriumTimeStep:M,9),VY(equlibriumTimeStep:M,9),VZ(equlibriumTimeStep:M,9),...
%         VX(equlibriumTimeStep:M,10),VY(equlibriumTimeStep:M,10),VZ(equlibriumTimeStep:M,10)];    
% plotmatrix(temp);
...
temp = [VX(equlibriumTimeStep:M,1),VY(equlibriumTimeStep:M,1),VZ(equlibriumTimeStep:M,1),...
        ...
        VX(equlibriumTimeStep:M,3),VY(equlibriumTimeStep:M,3),VZ(equlibriumTimeStep:M,3)];    
plotmatrix(temp);
title('Matrixplot of velocity of particles No.1-No.3');
savefig('MatrixplotVelocity.fig');
...
% flucturation of particle No.1's kinetic energy
KE_1 = Kinetic(equlibriumTimeStep:M,1);
delta_KE_1 = KE_1 - mean(KE_1);
fluct_KE_1 = mean(delta_KE_1.^2);
f = figure('Color',[1 1 1]);
set(f,'Name','Flucturation of kinetic energy');
plot(delta_KE_1,'r','LineWidth',2);
hold off;
title('Flucturation of kinetic energy: \Delta KE');
xlabel('Time Step');
ylabel('\Delta KE');
str1 = ['< ( \Delta KE )^2 > = ',num2str(fluct_KE_1)];
annotation(f,'textbox',...
    [0.174214285714286 0.713028169014085 0.157663443543356 0.106019450033535],...
    'String',str1,'FitBoxToText','off');
savefig('KEFlucturation.fig');
clear KE_1 delta_KE_1 fluct_KE_1 str1;
