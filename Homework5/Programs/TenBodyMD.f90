...
integer(kind=8), parameter:: N_time = 10000000000                                          ! Number of time step
real*8, parameter::  delta_t = 1.d-7                                                       ! Time step size  (really important)

real*8, parameter:: Temperature = 1.d0                                                     ! Temeprature of thermostat
!real*8, parameter:: Qm = N_particles * N_dimension * (10000000000*delta_t)**2             ! Thermostat's equvalent mass 
real*8, parameter:: Qm = 0.5                                                               ! Thermostat's equvalent mass 
...
real*8, parameter:: x1_ini = cos(0.d0/180.d0 * pi),   y1_ini = sin(0.d0/180.d0 * pi)       ! Particle No.1's position
real*8, parameter:: x2_ini = cos(38.d0/180.d0 * pi),  y2_ini = sin(38.d0/180.d0 * pi)      ! Particle No.2's position
real*8, parameter:: x3_ini = cos(75.d0/180.d0 * pi),  y3_ini = sin(75.d0/180.d0 * pi)      ! Particle No.3's position
real*8, parameter:: x4_ini = cos(110.d0/180.d0 * pi), y4_ini = sin(110.d0/180.d0 * pi)     ! Partical No.4's position
real*8, parameter:: x5_ini = cos(149.d0/180.d0 * pi), y5_ini = sin(149.d0/180.d0 * pi)     ! Partical No.5's Position
real*8, parameter:: x6_ini = cos(185.d0/180.d0 * pi), y6_ini = sin(185.d0/180.d0 * pi)     ! Particle No.6's position
real*8, parameter:: x7_ini = cos(213.d0/180.d0 * pi), y7_ini = sin(213.d0/180.d0 * pi)     ! Particle No.7's position
real*8, parameter:: x8_ini = cos(258.d0/180.d0 * pi), y8_ini = sin(258.d0/180.d0 * pi)     ! Particle No.8's position
real*8, parameter:: x9_ini = cos(286.d0/180.d0 * pi), y9_ini = sin(286.d0/180.d0 * pi)     ! Partical No.9's position
real*8, parameter:: x10_ini= cos(325.d0/180.d0 * pi), y10_ini= sin(325.d0/180.d0 * pi)     ! Partical No.10's Position




!real*8, parameter:: x1_ini = cos(0.d0/180.d0 * pi),   y1_ini = sin(0.d0/180.d0 * pi)       ! Particle No.1's position
!real*8, parameter:: x2_ini = cos(36.d0/180.d0 * pi),  y2_ini = sin(36.d0/180.d0 * pi)      ! Particle No.2's position
!real*8, parameter:: x3_ini = cos(72.d0/180.d0 * pi),  y3_ini = sin(72.d0/180.d0 * pi)      ! Particle No.3's position
!real*8, parameter:: x4_ini = cos(108.d0/180.d0 * pi), y4_ini = sin(108.d0/180.d0 * pi)     ! Partical No.4's position
!real*8, parameter:: x5_ini = cos(144.d0/180.d0 * pi), y5_ini = sin(144.d0/180.d0 * pi)     ! Partical No.5's Position
!real*8, parameter:: x6_ini = cos(180.d0/180.d0 * pi), y6_ini = sin(180.d0/180.d0 * pi)     ! Particle No.6's position
!real*8, parameter:: x7_ini = cos(216.d0/180.d0 * pi), y7_ini = sin(216.d0/180.d0 * pi)     ! Particle No.7's position
!real*8, parameter:: x8_ini = cos(252.d0/180.d0 * pi), y8_ini = sin(252.d0/180.d0 * pi)     ! Particle No.8's position
!real*8, parameter:: x9_ini = cos(288.d0/180.d0 * pi), y9_ini = sin(288.d0/180.d0 * pi)     ! Partical No.9's position
!real*8, parameter:: x10_ini= cos(324.d0/180.d0 * pi), y10_ini= sin(324.d0/180.d0 * pi)     ! Partical No.10's Position
...
& x_current(1,1), x_current(1,2), u_current(1,1), u_current(1,2), acceleration_int(1,1), acceleration_int(1,2),& 
& kinetic_energy(1), potential_energy(1),& 
& x_current(2,1), x_current(2,2), u_current(2,1), u_current(2,2), acceleration_int(2,1), acceleration_int(2,2),&
& kinetic_energy(2), potential_energy(2),&
& x_current(3,1), x_current(3,2), u_current(3,1), u_current(3,2), acceleration_int(3,1), acceleration_int(3,2),&
& kinetic_energy(3), potential_energy(3),&
& x_current(4,1), x_current(4,2), u_current(4,1), u_current(4,2), acceleration_int(4,1), acceleration_int(4,2),&
& kinetic_energy(4), potential_energy(4),&
& x_current(5,1), x_current(5,2), u_current(5,1), u_current(5,2), acceleration_int(5,1), acceleration_int(5,2),&
& kinetic_energy(5), potential_energy(5),&
& x_current(6,1), x_current(6,2), u_current(6,1), u_current(6,2), acceleration_int(6,1), acceleration_int(6,2),&
& kinetic_energy(6), potential_energy(6),& 
& x_current(7,1), x_current(7,2), u_current(7,1), u_current(7,2), acceleration_int(7,1), acceleration_int(7,2),&
& kinetic_energy(7), potential_energy(7),&
& x_current(8,1), x_current(8,2), u_current(8,1), u_current(8,2), acceleration_int(8,1), acceleration_int(8,2),&
& kinetic_energy(8), potential_energy(8),&
& x_current(9,1), x_current(9,2), u_current(9,1), u_current(9,2), acceleration_int(9,1), acceleration_int(9,2),&
& kinetic_energy(9), potential_energy(9),&
& x_current(10,1), x_current(10,2), u_current(10,1), u_current(10,2), acceleration_int(10,1), acceleration_int(10,2),&
& kinetic_energy(10), potential_energy(10)

100 format(1x,81ES24.15,/)
...
Write(*,106) x_current(4,1), x_current(4,2), u_current(4,1), u_current(4,2), kinetic_energy(4), potential_energy(4)
106 format(1x,', x4 = ',ES15.5,', y4 = ',ES15.5,', u4 = ',ES15.5,', v4 = ',ES15.5,', k4 = ',ES15.5,', p4 = ',ES15.5,/)
Write(*,107) x_current(5,1), x_current(5,2), u_current(5,1), u_current(5,2), kinetic_energy(5), potential_energy(5)
107 format(1x,', x5 = ',ES15.5,', y5 = ',ES15.5,', u5 = ',ES15.5,', v5 = ',ES15.5,', k5 = ',ES15.5,', p5 = ',ES15.5,/)
Write(*,108) x_current(6,1), x_current(6,2), u_current(6,1), u_current(6,2), kinetic_energy(6), potential_energy(6)
108 format(1x,', x6 = ',ES15.5,', y6 = ',ES15.5,', u6 = ',ES15.5,', v6 = ',ES15.5,', k6 = ',ES15.5,', p6 = ',ES15.5,/)
Write(*,109) x_current(7,1), x_current(7,2), u_current(7,1), u_current(7,2), kinetic_energy(7), potential_energy(7)
109 format(1x,', x7 = ',ES15.5,', y7 = ',ES15.5,', u7 = ',ES15.5,', v7 = ',ES15.5,', k7 = ',ES15.5,', p7 = ',ES15.5,/)
Write(*,110) x_current(8,1), x_current(8,2), u_current(8,1), u_current(8,2), kinetic_energy(8), potential_energy(8)
110 format(1x,', x8 = ',ES15.5,', y8 = ',ES15.5,', u8 = ',ES15.5,', v8 = ',ES15.5,', k8 = ',ES15.5,', p8 = ',ES15.5,/)
Write(*,111) x_current(9,1), x_current(9,2), u_current(9,1), u_current(9,2), kinetic_energy(9), potential_energy(9)
111 format(1x,', x9 = ',ES15.5,', y9 = ',ES15.5,', u9 = ',ES15.5,', v9 = ',ES15.5,', k9 = ',ES15.5,', p9 = ',ES15.5,/)
Write(*,112) x_current(10,1), x_current(10,2), u_current(10,1), u_current(10,2), kinetic_energy(10), potential_energy(10)
112 format(1x,', x10 = ',ES15.5,', y10 = ',ES15.5,', u10 = ',ES15.5,', v10 = ',ES15.5,', k10 = ',ES15.5,', p10 = ',ES15.5,/)
...
Write(20,106) x_current(4,1), x_current(4,2), u_current(4,1), u_current(4,2), kinetic_energy(4), potential_energy(4)
Write(20,107) x_current(5,1), x_current(5,2), u_current(5,1), u_current(5,2), kinetic_energy(5), potential_energy(5)
Write(20,108) x_current(6,1), x_current(6,2), u_current(6,1), u_current(6,2), kinetic_energy(6), potential_energy(6)
Write(20,109) x_current(7,1), x_current(7,2), u_current(7,1), u_current(7,2), kinetic_energy(7), potential_energy(7)
Write(20,110) x_current(8,1), x_current(8,2), u_current(8,1), u_current(8,2), kinetic_energy(8), potential_energy(8)
Write(20,111) x_current(9,1), x_current(9,2), u_current(9,1), u_current(9,2), kinetic_energy(9), potential_energy(9)
Write(20,112) x_current(10,1), x_current(10,2), u_current(10,1), u_current(10,2), kinetic_energy(10), potential_energy(10)
Write(20,113) Temperature
Write(20,114) zeta
...
! Compute zeta_new
do i = 1, N_particles
      temp = temp + u_current(i,1)**2 + u_current(i,2)**2
end do
...
Write(20,107) x_current(4,1), x_current(4,2), u_current(4,1), u_current(4,2), kinetic_energy(4), potential_energy(4)
Write(20,108) x_current(5,1), x_current(5,2), u_current(5,1), u_current(5,2), kinetic_energy(5), potential_energy(5)
Write(20,109) x_current(6,1), x_current(6,2), u_current(6,1), u_current(6,2), kinetic_energy(6), potential_energy(6)
Write(20,110) x_current(7,1), x_current(7,2), u_current(7,1), u_current(7,2), kinetic_energy(7), potential_energy(7)
Write(20,111) x_current(8,1), x_current(8,2), u_current(8,1), u_current(8,2), kinetic_energy(8), potential_energy(8)
Write(20,112) x_current(9,1), x_current(9,2), u_current(9,1), u_current(9,2), kinetic_energy(9), potential_energy(9)
Write(20,113) x_current(10,1), x_current(10,2), u_current(10,1), u_current(10,2), kinetic_energy(10), potential_energy(10)
Write(20,114) Temperature
Write(20,115) kinetic_energy_total/(0.5*N_particles*N_dimension)  
Write(20,116) zeta
Write(20,117) potential_energy_total, kinetic_energy_total
...
107 format(1x,', x4 = ',ES15.5,', y4 = ',ES15.5,', u4 = ',ES15.5,', v4 = ',ES15.5,', k4 = ',ES15.5,', p4 = ',ES15.5,/)
108 format(1x,', x5 = ',ES15.5,', y5 = ',ES15.5,', u5 = ',ES15.5,', v5 = ',ES15.5,', k5 = ',ES15.5,', p5 = ',ES15.5,/)
109 format(1x,', x6 = ',ES15.5,', y6 = ',ES15.5,', u6 = ',ES15.5,', v6 = ',ES15.5,', k6 = ',ES15.5,', p6 = ',ES15.5,/)
110 format(1x,', x7 = ',ES15.5,', y7 = ',ES15.5,', u7 = ',ES15.5,', v7 = ',ES15.5,', k7 = ',ES15.5,', p7 = ',ES15.5,/)
111 format(1x,', x8 = ',ES15.5,', y8 = ',ES15.5,', u8 = ',ES15.5,', v8 = ',ES15.5,', k8 = ',ES15.5,', p8 = ',ES15.5,/)
112 format(1x,', x9 = ',ES15.5,', y9 = ',ES15.5,', u9 = ',ES15.5,', v9 = ',ES15.5,', k9 = ',ES15.5,', p9 = ',ES15.5,/)
113 format(1x,', x10 = ',ES15.5,', y10 = ',ES15.5,', u10 = ',ES15.5,', v10 = ',ES15.5,', k10 = ',ES15.5,', p10 = ',ES15.5,/)
114 format(1x,'ThermostatTemperatureSetup = ',ES15.5,/)
115 format(1x,'SystemTemperatureSetup = ',ES15.5,/)
116 format(1x,'Damping coefficient = ',ES15.5,/)
117 format(1x,'SystemPotentialEnergy = ',ES15.5,', SystemKineticEnergy = ',ES15.5/)
