...
!
! Program Purpose:
!                  Solve five-bodies probelm in molecule simulation.
!  Version message:
...
integer, parameter:: N_particles = 5;                                                      ! Number of particle
...
!real*8, parameter:: x1_ini = cos(90.d0/180.d0 * pi), y1_ini = sin(90.d0/180.d0 * pi)       ! Particle No.1's position
!real*8, parameter:: x2_ini = cos(18.d0/180.d0 * pi), y2_ini = sin(18.d0/180.d0 * pi)       ! Particle No.2's position
!real*8, parameter:: x3_ini = -cos(18.d0/180.d0 * pi), y3_ini = sin(18.d0/180.d0 * pi)      ! Particle No.3's position
!real*8, parameter:: x4_ini = cos(54.d0/180.d0 * pi), y4_ini = -sin(54.d0/180.d0 * pi)      ! Partical No.4's position
!real*8, parameter:: x5_ini = -cos(54.d0/180.d0 * pi), y5_ini = -sin(54.d0/180.d0 * pi)     ! Partical No.5's Position




!real*8, parameter:: x1_ini = cos(90.d0/180.d0 * pi), y1_ini = sin(90.d0/180.d0 * pi)       ! Particle No.1's position
!real*8, parameter:: x2_ini = cos(30.d0/180.d0 * pi), y2_ini = sin(30.d0/180.d0 * pi)       ! Particle No.2's position
!real*8, parameter:: x3_ini = -cos(30.d0/180.d0 * pi), y3_ini = sin(30.d0/180.d0 * pi)      ! Particle No.3's position
!real*8, parameter:: x4_ini = cos(30.d0/180.d0 * pi), y4_ini = -sin(30.d0/180.d0 * pi)      ! Partical No.4's position
!real*8, parameter:: x5_ini = -cos(30.d0/180.d0 * pi), y5_ini = -sin(30.d0/180.d0 * pi)     ! Partical No.5's Position



real*8, parameter:: x1_ini = cos(90.d0/180.d0 * pi), y1_ini = sin(90.d0/180.d0 * pi)       ! Particle No.1's position
real*8, parameter:: x2_ini = cos(13.d0/180.d0 * pi), y2_ini = sin(13.d0/180.d0 * pi)       ! Particle No.2's position
real*8, parameter:: x3_ini = -cos(5.d0/180.d0 * pi), y3_ini = sin(5.d0/180.d0 * pi)      ! Particle No.3's position
real*8, parameter:: x4_ini = cos(60.d0/180.d0 * pi), y4_ini = -sin(60.d0/180.d0 * pi)      ! Partical No.4's position
real*8, parameter:: x5_ini = -cos(80.d0/180.d0 * pi), y5_ini = -sin(80.d0/180.d0 * pi)     ! Partical No.5's Position
...
& x_current(4,1), x_current(4,2), u_current(4,1), u_current(4,2), kinetic_energy(4), potential_energy(4),&
& x_current(5,1), x_current(5,2), u_current(5,1), u_current(5,2), kinetic_energy(5), potential_energy(5)
100 format(1x,31ES24.15,/)
